...
//		}
		Config config = ConfigUtils.loadConfig("input/v3.1/accessibility_config.xml");
		...
		accConfig.setShapeFileCellBasedAccessibility("C:/Users/J/Documents/Thesis/Shapefiles/solid_gitter.shp");
		...
		ActivityFacility fac1 = af.createActivityFacility(Id.create("xxx", ActivityFacility.class), Id.createLinkId("27543873"));
