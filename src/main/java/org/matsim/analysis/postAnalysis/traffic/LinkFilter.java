...
/**
 * TODO: Needs documentation @Chengqi.
 */
public final class LinkFilter implements LinkEnterEventHandler, VehicleEntersTrafficEventHandler {
	...
	/**
	 * Check whether link should be filtered.
	 */
