...
//	TODO: not sure if matsimConfig is needed here
//	TODO: check if last iter is needed, in more recent matsim versions all the drt output should be in the global output dir
	public AverageDrtDashboard(DrtConfigGroup drtConfigGroup, URL matsimConfigContext, String crs, int lastIteration) {
...
//				drtConfigGroup.drtServiceAreaShapeFile can not be null, otherwise simulation crashed, earlier
	...
	public void configure(Header header, Layout layout) {
		...
		//TODO: collect the information of all the below .csv etc and average them in separate analysis class, which gets called by postProcess method just like above
//		-> DrtAnalysisPostProcessing needs to be replaced by the new analysis class
//		search for R (?!) analysis, which collects the average 5 runs data and try to transalate it to java before starti ng from 0
