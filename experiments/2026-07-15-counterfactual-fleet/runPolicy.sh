...
# --export): DEMAND=base|counterfactual, FLEET_SIZE, PREBOOKING=off|on, and SEED.
set -euo pipefail
set -x
...
if [[ -z "${SCENARIO_ID:-}" ]]; then
	SCENARIO_ID="policy__demand-${DEMAND}__prebooking-${PREBOOKING}__fleet-${FLEET_SIZE}__seed-${SEED}"
fi
